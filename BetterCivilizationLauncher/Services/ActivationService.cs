...
using BetterCivilizationLauncher.Activation;
using BetterCivilizationLauncher.Core.Helpers;
using BetterCivilizationLauncher.Services;

using Windows.ApplicationModel.Activation;
using Windows.UI.Xaml;
using Windows.UI.Xaml.Controls;

namespace BetterCivilizationLauncher.Services
{
